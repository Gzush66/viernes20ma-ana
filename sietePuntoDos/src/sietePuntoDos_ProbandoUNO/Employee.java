...
//constructor normal
	public Employee(String dni, String nombre, String apellido1, String apellido2, double sueldo) {
		this.dni = dni;
		this.nombre = nombre;
...
//constructor con un solo apellido, para el ingles
	public Employee(String dni, String nombre, String apellido1, double sueldo) {
		super();
	}
