...
public class Principal {
	...
	public static void main(String[] args) {
		...
		p1.setEdad (35);
		p1.setNombre ("Pedro Manuel");
		
		
	}
}

	//en caso de que cumpla un año mas, como cambiamos la edad, si lo ponemos directamente: p1.edad=35 no funcionará
	// habremos de crear un metodo especifico para incrementar la edad  p1.setEdad(35;
