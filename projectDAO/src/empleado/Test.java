...
import persistencia.EmpleadoDAOFichero;
...
/*
 * SE CREA OBJETO DE LA INTERFAZ, HACIENDO USO DE LA CLASE 
 * EmpleadoDAOFichero
 */
		EmpleadoDAO other = new EmpleadoDAOFichero();
		
/*
 * viendo que el objeto anterior no puede hacer uso de los metodos 
 * de la clase EmpleadoDAOFichero, creo uno objeto directo de dicha clase
 * para ver si puedo usar asi dichos metodos	
 */
		EmpleadoDAOFichero empFichero = new EmpleadoDAOFichero();
		
		
		
		/*	por el contrario 
		 * 	el objeto joe que hace uso de la clase EmpleadoDAOFichero
		...
		//empFichero.getEmpleados();
		
		//empFichero.crearCSV(sc);
