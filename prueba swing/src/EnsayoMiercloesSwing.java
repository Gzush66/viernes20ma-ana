...
public class EnsayoMiercloesSwing extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EnsayoMiercloesSwing ventana = new EnsayoMiercloesSwing();
		ventana.setVisible(true);
	}

	public EnsayoMiercloesSwing() {
